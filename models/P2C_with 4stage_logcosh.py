...
class HierarchicalDecoder(nn.Module):
    def __init__(self, latent_dim=1024, crop_point_num=2048):
        ...
        self.fc0_1 = nn.Linear(2048, 32 * 3)         # Stage 1: 32 points
        self.fc1_1 = nn.Linear(1024, 64 * 3)         # Stage 2: 64 points
        self.fc2_1 = nn.Linear(512, 128 * 3)         # Stage 3: 128 points
        self.fc3_1 = nn.Linear(256, crop_point_num * 3)  # Stage 4: Final output
...
class P2C(nn.Module):
    ...
    def _get_lossfnc_and_weights(self, config):
        ...
        self.latent_criterion = lambda input, target: torch.log(torch.cosh(input - target)).mean()  # Log-Cosh Loss
        ...
        self.manifold_weight = config.latent_weight  # Note: Correct if config.manifold_weight is intended
